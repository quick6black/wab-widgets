define([
  ...
  "dojo/text!./templates/RequestStatementPopup.html",
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    startup: function () {
      ...
      if(this.wabWidget && this.wabWidget.recordTemplateLayers) {
        ...
        var radiusField = arrayUtils.filter(recordTemplate.layer.fields,
          function (field) {
    ...
    **/
    _requestLLURStatementPopup: function () {
      //creating ok button
    ...
    _optionsClick: function (radiusOption) {
