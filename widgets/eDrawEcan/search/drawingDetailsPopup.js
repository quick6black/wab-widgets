define([
  ...
  "dojo/_base/lang",
  'dojo/_base/array',
  "dojo/text!./templates/drawingDetailsPopup.html",
  "jimu/dijit/Popup",
  "dojo/dom-construct",
  'dojo/dom-style',
  'dojo/date/locale',  
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    **/
    _createDrawingDetailsPopup: function () {
      //creating ok button
