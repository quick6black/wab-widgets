define([
  ...
  "dojo/_base/lang",
  'dojo/_base/array',
  "dojo/text!./bufferFeaturesPopup.html",
  "jimu/dijit/Popup",
  "dojo/dom-construct",
  'dojo/dom-style',
  'esri/units'  
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _initSettingsForm: function () {
      //set buffer options
      var defaultOption = null, bufferOptions = [];
    ...
    _getBufferConfigOption : function (bufferOptionLabel) {
      var option = null
      array.forEach(this.config.bufferOptions, lang.hitch(this, function (bufferInfo) {
    ...
    _getMeasurementOption : function (bufferOptionLabel) {
    ...
    **/
    _createBufferSettingsPopup: function () {
      //creating ok button
    ...
    **/
    _getBufferSettings: function () {
      var distance = this.bufferDistanceNode.value, distances = [];
