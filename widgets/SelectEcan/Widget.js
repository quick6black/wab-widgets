...
SelectableLayerItem, FeatureItem, Graphic, geometryEngine, Polygon) {
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    selectByFeature : function (featureSet) {
        ...
        switch(featureSet.features.length) {
            ...
            default:
                ...
                var searchGeometry = null, mergeGeometries = [];
    ...
    _pointToPolygon : function (pt, offset) {
      offset = offset || 1;
      var xmin = pt.x - offset, ymin = pt.y - offset, xmax = pt.x + offset, ymax = pt.y + offset;
      return new Polygon({"rings" : [[[xmin,ymin],[xmin,ymax],[xmax,ymax],[xmax,ymin],[xmin,ymin]]],
        "spatialReference" : { "wkid" : pt.spatialReference.wkid }
      });
    },

    _simulateDrawAction : function (graphic, geotype, commontype, shiftKey, ctrlKey, metaKey) {
