define({
  ...
  "labels": {
    ...
    "sameLayerAppend": "レイヤーが複数回リストに表示されている場合は、フィールド間に次の演算子を使用します。",
  ...
  "inputs": {
    ...
    "webmapAppendMode": "次の演算子を使用してフィルターを既存の Web マップ フィルターに追加 ",
    "webmapAppendModeTip": "フィルター セットを既存の Web マップ フィルターに追加するオプションです。サポートされている演算子は OR と AND です。",
