...
- Bug - If webmap ustilises a basemaps that the widget has not been configured with, the basemap gallery does not fully load and users cannot change basemaps.
