...
define(['dojo/_base/declare', 'dojo/_base/fx', 'dojo/_base/lang', 'dojo/aspect', 'dojo/dom-attr', 'dojo/dom-construct', 'dojo/dom-style', 'dojo/json', 'dojo/on', 'dojo/query', 'dijit/popup', 'dijit/registry', 'dijit/TooltipDialog', 'dojo/text!./Mixin.html', 'dojo/text!./config.json', 'xstyle/css!./css/style.css'], function (declare, fx, lang, aspect, domAttr, domConstruct, domStyle, JSON, on, query, popup, registry, TooltipDialog, _womTemplate, _womConfig) {
  var clazz = declare([], {
    ...
    _womStartup: function _womStartup() {
    ...
    _womDestroy: function _womDestroy() {
    ...
    _womInitialize: function _womInitialize() {
      var titleBar = query('div.title', this._womWidgetPanel.domNode);
      if (titleBar.length > 0) {
        this.widgetOpacityBtn = domConstruct.place('<div class="opacity-btn jimu-vcenter jimu-float-trailing" style="margin-top: 0px;"></div>', titleBar[0], 'last');
    ...
    _womInitializeSlider: function _womInitializeSlider(count) {
    ...
    _womSliderChange: function _womSliderChange(value) {
      this._womOpacityOut = value;
      this._womSetWidgetOpacity();
    },

    _womSetWidgetOpacity: function _womSetWidgetOpacity(evt) {
      var opacity;
    ...
    _womOnFoldStateChanged: function _womOnFoldStateChanged() {
    ...
    _womFadeOut: function _womFadeOut(node, delay) {
      var fadeArgs = {
        node: node,
        duration: 700,
