define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/Deferred', 'dojo/dom-geometry', 'dojo/dom-style', 'esri/request', 'jimu/BaseWidget', 'jimu/dijit/Message', 'jimu/portalUtils', './PrintPlus', './_WidgetOpacityMixin/Mixin', //lcs - Widget Opacity
'./_WidgetMetadataMixin/Mixin' //lcs - Widget Metadata 
], function (declare, lang, Deferred, domGeom, domStyle, esriRequest, BaseWidget, Message, portalUtils, Print, _WidgetOpacityMixin, //lcs - Widget Opacity
_WidgetMetadataMixin //lcs - Widget Metadata
  ...
  return declare([BaseWidget, _WidgetOpacityMixin, _WidgetMetadataMixin], { //lcs - Widget Opacity, Metadata
    ...
    _initPrinter: function _initPrinter() {
    ...
    isAsync: function isAsync(serviceURL) {
    ...
    _isWidgetDocked: function _isWidgetDocked() {
