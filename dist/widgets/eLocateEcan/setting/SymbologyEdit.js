/*global define*/
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/on', 'jimu/dijit/SymbolPicker', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/Message', 'dojo/text!./SymbologyEdit.html', 'esri/symbols/jsonUtils'], function (declare, lang, array, html, on, SymbolPicker, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, BaseWidgetSetting, Message, template, jsonUtils) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _onAddressSymbolChange: function _onAddressSymbolChange(newSymbol) {
      this._symbols.addresspicturemarkersymbol = newSymbol.toJson();
    },

    _onCoordinateSymbolChange: function _onCoordinateSymbolChange(newSymbol) {
      this._symbols.coordpicturemarkersymbol = newSymbol.toJson();
    },

    _onReverseSymbolChange: function _onReverseSymbolChange(newSymbol) {
