...
define(['dojo/_base/declare', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dojo/Evented', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/array', 'dojo/on', 'dojo/query', 'dojo/mouse', 'jimu/utils'], function (declare, _WidgetBase, _TemplatedMixin, Evented, lang, html, array, on, query, mouse, jimuUtils) {
  return declare([_WidgetBase, _TemplatedMixin, Evented], {
    ...
    _updateHeadDiv: function _updateHeadDiv() {
    ...
    addRow: function addRow(rowData, /* optional */dontUpdateUI) {
      this._rowIndex++;
      var result = {
        success: false,
        tr: null,
    ...
    _setRowOdevity: function _setRowOdevity() {
      var trs = query('.simple-table-tr', this.tbody);
      trs.removeClass('odd');
