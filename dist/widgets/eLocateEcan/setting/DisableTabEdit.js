...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/on", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "jimu/BaseWidgetSetting", "jimu/dijit/Message", "dojo/text!./DisableTabEdit.html"], function (declare, lang, array, on, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, BaseWidgetSetting, Message, template) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    _initDiasableTabsTable: function _initDiasableTabsTable() {
    ...
    _inArray: function _inArray(array, name) {
    ...
    _createDisableTab: function _createDisableTab(args) {
