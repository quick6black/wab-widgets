...
define(['dojo/_base/declare', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/_base/query', 'dojo/on', 'dojo/json', 'jimu/dijit/SimpleTable', 'jimu/dijit/Message', 'jimu/dijit/Popup', './SymbologyEdit', './UnitEdit', './DisableTabEdit', 'dojo/keys', 'dijit/form/NumberSpinner', 'dijit/form/Select', './LocatorSourceSetting'], function (declare, _WidgetsInTemplateMixin, BaseWidgetSetting, lang, array, html, query, on, json, SimpleTable, Message, Popup, SymbologyEdit, UnitEdit, DisableTabEdit, keys, NumberSpinner, Select, LocatorSourceSetting) {
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
        //these two properties is defined in the BaseWidget
        baseClass: 'widget-eLocate-ecan-setting',
        popupsymedit: null,
        popupunitedit: null,
        ...
        _initLocator: function _initLocator(setting, definition) {
        ...
        _openUnitEdit: function _openUnitEdit(title, tr) {
        ...
        _onUnitEditOk: function _onUnitEditOk() {
        ...
        _onUnitEditClose: function _onUnitEditClose() {
            var unitConfig = this.popupunitedit.getConfig();
            if (this.popupState === 'ADD') {
        ...
        _getAllUnits: function _getAllUnits() {
        ...
        _initUnitsTable: function _initUnitsTable() {
            this.unitList.clear();
        ...
        _createUnit: function _createUnit(args) {
            args.setting = this;
            args.nls = this.nls;
            var rowData = {
        ...
        _onUnitItemRemoved: function _onUnitItemRemoved(tr) {
            delete tr.singleUnit;
        },

        _onUnitItemSelected: function _onUnitItemSelected(tr) {
            console.info(tr.singleUnit);
        },

        _onDTEditOk: function _onDTEditOk() {
        ...
        _onDTEditClose: function _onDTEditClose() {
            this.popupDisableTabedit = null;
            this.popup3 = null;
        },

        _openDTEdit: function _openDTEdit(title, disTabs) {
