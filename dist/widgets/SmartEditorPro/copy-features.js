...
///////////////////////////////////////////////////////////////////////////
define(['dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dojo/_base/declare', 'dojo/Evented', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/dom-construct', 'dojo/on', 'jimu/dijit/CheckBox', 'dojo/dom-class', "dojo/dom-attr", './highlightSymbolUtils', 'esri/layers/GraphicsLayer', 'dojo/text!./copy-features.html', 'jimu/dijit/Message'], function (_WidgetBase, _TemplatedMixin, declare, Evented, lang, array, domConstruct, on, CheckBox, domClass, domAttr, highlightSymbolUtils, GraphicsLayer, template, Message) {
  ...
  return declare([_WidgetBase, Evented, _TemplatedMixin], {
    ...
    startup: function startup() {
      ...
      this.highlightGraphicsLayer = this._createNewGraphicsLayer("highlightGraphicsLayer");
    },
    ...
    postCreate: function postCreate() {
      ...
      this.own(on(this.createMultipleFeaturesBtn, "click", lang.hitch(this, this._createMultipleFeaturesBtnClicked)));
      this.own(on(this.createSingleFeatureBtn, "click", lang.hitch(this, this._createSingleFeatureBtnClicked)));
    },

    selectFeaturesToCopy: function selectFeaturesToCopy(selectedFeatures) {
      if (selectedFeatures && selectedFeatures.length > 0) {
        ...
        */
        ...
        for (var layerId in this.featureTitlesByLayerId) {
          ...
          this.layerCheckBoxNodes[layerId] = this._createListNode(layerName, groupNode, false, layerId);
     ...
     */
    _processSelectedFeatures: function _processSelectedFeatures(selectedFeatures) {
      this.featuresByLayerId = {};
      this.featureTitlesByLayerId = {};
     ...
     */
    _createFeatureEntries: function _createFeatureEntries(layerId, groupNode) {
     ...
     */
    _createListNode: function _createListNode(layerLabel, groupNode, isChild, layerId) {
     ...
     */
    _createMultipleFeaturesBtnClicked: function _createMultipleFeaturesBtnClicked() {
      var allSelectedGeometries = [],
          allSelectedFeatures;
     ...
     */
    _createSingleFeatureBtnClicked: function _createSingleFeatureBtnClicked() {
     ...
     */
    _validateSelectedFeature: function _validateSelectedFeature(allSelectedFeatures) {
      if (!allSelectedFeatures || allSelectedFeatures.length <= 0) {
        Message({
     ...
     */
    _getSelectedFeaturesForCopy: function _getSelectedFeaturesForCopy() {
      var layerId,
          allSelectedFeatures = [];
     ...
     */
    _getSelectedFeaturesByLayerId: function _getSelectedFeaturesByLayerId(layerId) {
     ...
     */
    _showHideSingleFeatureButton: function _showHideSingleFeatureButton(geometryType) {
     ...
     */
    _createNewGraphicsLayer: function _createNewGraphicsLayer(layerId) {
     ...
     */
    _highlightFeatures: function _highlightFeatures() {
     ...
     */
    _highlightSingleLayerFeatures: function _highlightSingleLayerFeatures(layerId) {
