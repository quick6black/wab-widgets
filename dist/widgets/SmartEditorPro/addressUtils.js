...
define(["dojo/_base/declare", "dojo/_base/lang", 'dojo/Deferred', "esri/tasks/locator", "dijit/_WidgetBase"], function (declare, lang, Deferred, Locator, _WidgetBase) {
  return declare([_WidgetBase], {
    ...
    locateAddress: function locateAddress(geometry) {
      ...
      if (this._locatorInstance) {
        this._locatorInstance.locationToAddress(geometry, 100, lang.hitch(this, function (result) {
