...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", 'dojo/on', "dojo/text!./XYCoordinates.html", 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', "jimu/dijit/Popup", "dojo/dom-attr"], function (declare, Evented, lang, on, template, _WidgetsInTemplateMixin, BaseWidgetSetting, Popup, domAttr) {
    return declare([BaseWidgetSetting, Evented, _WidgetsInTemplateMixin], {
        ...
        **/
        _eventListener: function _eventListener() {
            this.own(on(this.coordinatesDropDown, "change", lang.hitch(this, this._onChangeDropDown)));
            this.own(on(this.xAttributeTextBox, "change", lang.hitch(this, this._onTextBoxValueChanged)));
            this.own(on(this.yAttributeTextBox, "change", lang.hitch(this, this._onTextBoxValueChanged)));
        },
        ...
        * @memberOf widgets/SmartEditor/XYCoordinates
        **/
        _onChangeDropDown: function _onChangeDropDown() {
            ...
            if (this.coordinatesDropDown.value === "Map Spatial Reference") {
                domAttr.set(this.xAttributeTextBoxLabel, "innerHTML", this.nls.xAttributeTextBoxLabel);
                domAttr.set(this.yAttributeTextBoxLabel, "innerHTML", this.nls.yAttributeTextBoxLabel);
                this.xAttributeTextBox.set("value", "");
                this.yAttributeTextBox.set("value", "");
            } else {
                domAttr.set(this.xAttributeTextBoxLabel, "innerHTML", this.nls.latitudeTextBoxLabel);
                domAttr.set(this.yAttributeTextBoxLabel, "innerHTML", this.nls.longitudeTextBoxLabel);
                this.xAttributeTextBox.set("value", "");
                this.yAttributeTextBox.set("value", "");
            }
        },
        ...
        * @memberOf widgets/SmartEditor/XYCoordinates
        **/
        _onTextBoxValueChanged: function _onTextBoxValueChanged() {
