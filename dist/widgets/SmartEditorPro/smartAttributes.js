...
define(["dojo", "dojo/_base/declare", 'dojo/_base/lang', 'dojo/_base/array', 'dojo/dom-class', 'dojo/on', 'dojo/query', 'dijit/registry', 'jimu/filterUtils', 'jimu/dijit/Filter', 'jimu/BaseWidgetSetting'], function (dojo, declare, lang, array, domClass, on, query, registry, filterUtils, Filter, BaseWidgetSetting) {
  return declare([BaseWidgetSetting], {
    ...
    _processLayer: function _processLayer() {
    ...
    process_relative_date: function process_relative_date(date_oper, value, first) {
      var today = new Date();
      var is_num = this._isNumeric(value);
      if (date_oper === undefined || date_oper === null || date_oper === '') return value;
    ...
    process_part: function process_part(part) {
    ...
    processFilter: function processFilter(filter) {
      var partResults = [];
    ...
    ruleValid: function ruleValid(partResults, logOp) {
    ...
    myIsNaN: function myIsNaN(o) {
      return o !== o;
    },
    _isNumeric: function _isNumeric(n) {
      return !isNaN(parseFloat(n)) && isFinite(n);
    },
    validatePart: function validatePart(operator, field, value1, value2, caseSensitive) {
      var d = null;
      ...
      switch (operator) {
        ...
        case this.OPERATORS.numberOperatorIsBlank:
          if (field === null || field === undefined || this._isNumeric(field) === false) {
            return true;
          }
          return false;
        case this.OPERATORS.numberOperatorIsNotBlank:
          if (field !== null && field !== undefined && this._isNumeric(field) === true) {
            return true;
          }
          return false;
    ...
    _processChildNodes: function _processChildNodes(element, state) {
    ...
    _smartComboValidate: function _smartComboValidate() {
      this.toggleFields();
    },
    ...
    _removeRequireFieldMarkings: function _removeRequireFieldMarkings(valueCell, parent, widget) {
      var nl = null;
    ...
    _removeRedAst: function _removeRedAst(row, fieldName) {
      if (this._gdbRequiredFields.indexOf(fieldName) === -1) {
    ...
    _removeHideRule: function _removeHideRule(parent) {
      if (domClass.contains(parent, "hideField")) {
        domClass.remove(parent, "hideField");
      }
    },
    _removeDisableRule: function _removeDisableRule(fieldName, valueCell) {
    ...
    _remove: function _remove(row, fieldName, valueCell, parent, widget) {
              ...
              switch (actionType) {
                ...
                case 'Disabled':
                  ...
                  if (valueCell2 !== null) {
                    ...
                    domClass.add(valueCell2, ["dijitValidationTextBox", "dijitTextBoxDisabled", "dijitComboBoxDisabled", "dijitValidationTextBoxDisabled", "dijitDisabled"]);
