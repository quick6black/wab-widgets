...
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", 'dojo/json', "dojo/text!./FilterPage.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', "jimu/dijit/Popup", 'jimu/dijit/Filter', 'esri/lang', "dijit/form/CheckBox", 'dojo/dom-construct'], function (declare, Evented, lang, JSON, template, _TemplatedMixin, BaseWidgetSetting, Popup, Filter, esriLang, CheckBox, domConstruct) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    popup: function popup(tr) {
      ...
      if (filterInfo) {
        if (filterInfo.filter === undefined || filterInfo.filter === null || filterInfo.filter === '') {
          this._filter.build({
            url: this._url,
            partsObj: null,
