...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", 'dojo/on', "dojo/text!./ChooseFromLayer.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', "jimu/dijit/Popup", "dijit/form/Select", 'jimu/dijit/LayerChooserFromMap', 'jimu/dijit/LayerChooserFromMapWithDropbox', "dojo/Evented"], function (declare, lang, array, on, template, _TemplatedMixin, BaseWidgetSetting, Popup, Select, LayerChooserFromMap, LayerChooserFromMapWithDropbox, Evented) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
     ...
     */
    _addLayerSelectors: function _addLayerSelectors() {
    ...
    _createFiltersForLayerSelector: function _createFiltersForLayerSelector() {
      var types, featureLayerFilter, imageServiceLayerFilter, filters, combinedFilter, domainFieldfilter;
     ...
     */
    _createDomainFieldFilter: function _createDomainFieldFilter() {
     ...
     */
    _addLayerFieldsOptions: function _addLayerFieldsOptions() {
     ...
     */
    _addLayerFieldsValueDropdown: function _addLayerFieldsValueDropdown() {
     ...
     */
    _createFieldsDropDownOpt: function _createFieldsDropDownOpt() {
     ...
     * This function used to create options of domainFieldsDropdown
     */
    _createFieldValueDropDownOpt: function _createFieldValueDropDownOpt() {
      var selectedField,
          codedvalue,
          selectedLayer,
          selectedFieldCodeValues,
          options = [];
      if (this.layerSelector.getSelectedItem()) {
     ...
     */
    _getDomainFieldValue: function _getDomainFieldValue() {
