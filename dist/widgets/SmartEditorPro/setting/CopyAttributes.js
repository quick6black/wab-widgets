...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/Evented", "dojo/query", "dojo/dom-style", "dojo/_base/lang", "dojo/_base/array", 'dojo/on', 'dojo/dom-construct', "dojo/text!./CopyAttributes.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/SimpleTable', "jimu/dijit/Popup", 'esri/lang', "./Intersection", "./Coordinates", "./Address"], function (declare, Evented, query, domStyle, lang, array, on, domConstruct, template, _TemplatedMixin, BaseWidgetSetting, Table, Popup, esriLang, Intersection, Coordinate, Address) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    ValidFieldsForCoordinates: ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble", "esriFieldTypeString"],
    ValidFieldsByType: {
    ...
    _getConfigActionOrder: function _getConfigActionOrder() {
      var result = [],
          defaultResult = [];
      ...
      if (this._fieldValues !== undefined && this._fieldValues !== null) {
    ...
    _getValidGeocoderFields: function _getValidGeocoderFields() {
      var validFieldTypes = [],
          currentFieldGeocoderFields = [];
      ...
      if (this._geocoderSettings && this._geocoderSettings.hasOwnProperty('url')) {
        currentFieldGeocoderFields = array.filter(this._geocoderSettings.fields, function (field) {
    ...
    _getConfigAction: function _getConfigAction(actionName) {
      var result = null;
      if (this._fieldValues !== undefined && this._fieldValues !== null) {
        if (this._fieldValues.hasOwnProperty(this._fieldName)) {
    ...
    _nlsActionToConfig: function _nlsActionToConfig(label) {
      switch (label) {
    ...
    popupActionsPage: function popupActionsPage() {
      if (this._fieldsPopUp) {
        this._fieldsPopUp.close();
        this._fieldsPopUp = null;
      }
      this._fieldsPopUp = new Popup({
        titleLabel: esriLang.substitute({ fieldname: this._fieldName }, this.nls.actionPage.title),
        width: 920,
        maxHeight: 600,
        autoHeight: true,
        content: this,
        buttons: [{
          ...
          onClick: lang.hitch(this, function () {
            ...
            array.forEach(rows, function (row) {
              ...
              if (newAction.actionName === "Preset" && this._configuredPresetInfos && !this._configuredPresetInfos.hasOwnProperty(this._fieldName)) {
    ...
    _initActionsTable: function _initActionsTable() {
      var fields2 = [{
        name: 'enabled',
      ...
      this.own(on(this._copyAttrTable, 'actions-edit', lang.hitch(this, this._onActionEdit)));
    },

    _onActionEdit: function _onActionEdit(tr) {
      var rowData;
      this._removeGroupInfo = null;
    ...
    _removeFromGroup: function _removeFromGroup(tr) {
    ...
    _createIntersectionPanel: function _createIntersectionPanel(tr) {
      ...
      this.own(on(this._intersectionDijit, "attributeActionUpdated", lang.hitch(this, function () {
        this._removeFromGroup(tr);
      })));
    },

    _createCoordinatesPanel: function _createCoordinatesPanel(tr) {
      ...
      this.own(on(this._coordinatesDijit, "attributeActionUpdated", lang.hitch(this, function () {
        this._removeFromGroup(tr);
      })));
    },

    _createAddressPanel: function _createAddressPanel(tr) {
      ...
      this.own(on(this._addressDijit, "attributeActionUpdated", lang.hitch(this, function () {
        this._removeFromGroup(tr);
      })));
    },

    _setActionsTable: function _setActionsTable() {
      ...
      array.forEach(actions, function (action) {
        ...
        if (this._configuredFieldValues[action].hasOwnProperty('attributeActionGroupName')) {
          settings.attributeActionGroupName = this._configuredFieldValues[action].attributeActionGroupName;
        }
    ...
    geocoderConfigured: function geocoderConfigured() {
      if (this._geocoderSettings && this._geocoderSettings.hasOwnProperty('url')) {
        this._createAddressPanel();
      }
    },

    _editGroup: function _editGroup(rowData) {
    ...
    onGroupEditingStart: function onGroupEditingStart(tabTitle) {
      this.emit("onGroupEditingStart", tabTitle);
    },
    removeFromGroup: function removeFromGroup(info) {
