...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", 'dojo/on', 'dojo/dom-construct', 'dojo/query', 'dojo/json', "dojox/html/entities", "dojo/text!./FieldValidation.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/SimpleTable', "jimu/dijit/Popup", "./FilterPage"], function (declare, lang, array, on, domConstruct, query, JSON, entities, template, _TemplatedMixin, BaseWidgetSetting, Table, Popup, FilterPage) {
  return declare([BaseWidgetSetting, _TemplatedMixin], {
    ...
    _getConfigActionOrder: function _getConfigActionOrder() {
      var result = [];
      if (this._fieldValidations !== undefined && this._fieldValidations !== null) {
    ...
    _initActionsTable: function _initActionsTable() {
      ...
      this.own(on(this._validationTable, 'actions-edit', lang.hitch(this, this._onEditFieldInfoClick)));
      this.own(on(this._validationTable, 'actions-delete', lang.hitch(this, this._onDeleteFieldInfoClick)));
    },

    _onDeleteFieldInfoClick: function _onDeleteFieldInfoClick(tr) {
      ...
      array.forEach(actions, function (action) {
        ...
        if (configAction !== undefined && configAction !== null) {
          if (configAction.hasOwnProperty("filter")) {
            if (configAction.filter !== undefined && configAction.filter !== null) {
    ...
    _removeFilter: function _removeFilter(tr) {
      this._validationTable.editRow(tr, {
        'expression': '',
        'filter': null,
    ...
    _editGroup: function _editGroup(groupName) {
    ...
    onGroupEditingStart: function onGroupEditingStart() {},
