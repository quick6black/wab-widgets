...
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", "dijit/form/Select", "dojo/_base/array", 'dojo/dom-attr', 'dojo/dom-construct', 'dojo/on', 'dojo/query', 'dojo/promise/all', 'dojo/Deferred', "dojo/text!./Intersection.html", 'dijit/_TemplatedMixin', 'jimu/dijit/LayerChooserFromMap', 'jimu/dijit/LayerChooserFromMapWithDropbox', 'jimu/BaseWidgetSetting', 'jimu/dijit/SimpleTable', 'jimu/dijit/Message', "jimu/dijit/Popup", "jimu/dijit/CheckBox", 'dijit/popup', 'dijit/TooltipDialog', 'dijit/form/ValidationTextBox', 'dijit/form/NumberTextBox', 'dijit/form/DropDownButton', 'dojo/dom-class', "./layersAndFieldsApplyOn"], function (declare, Evented, lang, Select, array, domAttr, domConstruct, on, query, all, Deferred, template, _TemplatedMixin, LayerChooserFromMap, LayerChooserFromMapWithDropbox, BaseWidgetSetting, Table, Message, Popup, CheckBox, popup, TooltipDialog, TextBox, NumberTextBox, DropDownButton, domClass, layersAndFieldsApplyOn) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    isGroup: false,
    ValidFieldsByType: {
      "esriFieldTypeOID": ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeSmallInteger": ["esriFieldTypeOID", "esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeInteger": ["esriFieldTypeOID", "esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeDouble": ["esriFieldTypeOID", "esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeSingle": ["esriFieldTypeOID", "esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeGUID": ["esriFieldTypeGUID", "esriFieldTypeGlobalID"],
      "esriFieldTypeDate": ["esriFieldTypeDate"],
      "esriFieldTypeString": ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble", "esriFieldTypeString", "esriFieldTypeGUID", "esriFieldTypeDate", "esriFieldTypeOID", "esriFieldTypeGlobalID"]
    },
    ValidFieldsByTypeToApplyOn: {
      "esriFieldTypeInteger": ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
    ...
    _createDialogContent: function _createDialogContent() {
    ...
    _addDataTypeOptions: function _addDataTypeOptions() {
      var options = [{
    ...
    _initTable: function _initTable() {
      ...
      this.own(on(this._layerTable, 'actions-edit', lang.hitch(this, this._onEditFieldInfoClick)));
      this.own(on(this._layerTable, 'actions-delete', lang.hitch(this, this._onDeleteFieldInfoClick)));
      this._populateTableData();
    },
    _populateTableData: function _populateTableData() {
      ...
      array.forEach(this._fieldValues.Intersection.fields, lang.hitch(this, function (field) {
        ...
        if (field.layerId && this.layerInfos.getLayerInfoById(field.layerId)) {
    ...
    _createToleranceSettingsDialogContent: function _createToleranceSettingsDialogContent() {
    ...
    _addToleranceSettings: function _addToleranceSettings(tableRow, prevSettings) {
      ...
      if (tableRow.toleranceSettings.useDefault) {
        ...
        toleranceTextValue = tableRow.toleranceSettings.value + " " + this.nls.units[tableRow.toleranceSettings.unit];
      }
    ...
    _addLayersDropDown: function _addLayersDropDown(tr, fieldData) {
      ...
      if (fieldData) {
        ...
        layerSelector.setSelectedLayer(this.layerInfos.getLayerInfoById(fieldData.layerId).layerObject);
      }
      this.own(on(layerSelector, 'selection-change', lang.hitch(this, function () {
    ...
    _createIntersectionLayerfilter: function _createIntersectionLayerfilter(validFieldSet) {
    ...
    _createFiltersForLayerSelector: function _createFiltersForLayerSelector() {
      var types, featureLayerFilter, imageServiceLayerFilter, filters, combinedFilter, intersectionLayerfilter, validFieldSet;
    ...
    _isLayerEditable: function _isLayerEditable(currentLayer) {
      ...
      if (currentLayer && currentLayer.layerObject && currentLayer.layerObject.getEditCapabilities) {
    ...
    _addFieldsDropDown: function _addFieldsDropDown(tableRow, fieldData) {
    ...
    _addLayerNameOptions: function _addLayerNameOptions() {
      var layers,
          options = [];
    ...
    _addLayerFieldOptions: function _addLayerFieldOptions(row) {
      var selectedLayer,
          options = [],
          validFieldSet = [];
      ...
      array.forEach(selectedLayer.fields, lang.hitch(this, function (currentField) {
        ...
        if (currentField.type !== "esriFieldTypeGeometry" && currentField.type !== "esriFieldTypeBlob" && currentField.type !== "esriFieldTypeRaster" && currentField.type !== "esriFieldTypeXML" && validFieldSet.indexOf(currentField.type) > -1) {
          options.push({
    ...
    */
    _createLayerFieldsFilter: function _createLayerFieldsFilter(fieldType) {
      var validFieldSet = [],
          layerDetails = {};
    ...
    */
    _createLayersAndFields: function _createLayersAndFields() {
