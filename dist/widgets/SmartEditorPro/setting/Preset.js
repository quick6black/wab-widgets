...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", "dojo/_base/array", 'dojo/dom-construct', 'dojo/on', "dojo/text!./Preset.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', "jimu/dijit/Popup", "dijit/form/Select", 'dijit/form/ValidationTextBox', './ChooseFromLayer', 'dojo/dom-class', 'dijit/form/DateTextBox', 'dijit/form/NumberTextBox', 'dijit/form/TimeTextBox', "./layersAndFieldsApplyOn", '../presetUtils'], function (declare, Evented, lang, array, domConstruct, on, template, _TemplatedMixin, BaseWidgetSetting, Popup, Select, TextBox, ChooseFromLayer, domClass, DateTextBox, NumberTextBox, TimeTextBox, layersAndFieldsApplyOn, presetUtils) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    _createValueDijit: function _createValueDijit(fieldType, presetValue) {
      var nodesArray,
          value = null;
     ...
     */
    _isDomainField: function _isDomainField() {
     ...
     */
    displaySelectValueButton: function displaySelectValueButton(fieldType) {
      ...
      if (this.hasDomainField) {
        if (fieldType === "esriFieldTypeString" || fieldType === "esriFieldTypeInteger") {
    ...
    */
    _createLayersAndFields: function _createLayersAndFields(dataType) {
        ...
        "buttons": [{
          ...
          onClick: lang.hitch(this, function () {
            ...
            if (this.presetValueTimeNode) {
              ...
              selectedValue = presetUtils.getDateFieldValue({ "type": "esriFieldTypeDate" }, [this.presetValueDijitNode, this.presetValueTimeNode]);
     ...
     */
    createDijitOnDataTypeChange: function createDijitOnDataTypeChange(dataTypeDropdownValue) {
      var node,
          timeNode,
          nodes = [];
     ...
     */
    _onSelectPresetValueButtonClick: function _onSelectPresetValueButtonClick() {
