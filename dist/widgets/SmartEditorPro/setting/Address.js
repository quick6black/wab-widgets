...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", "dojo/_base/array", 'dojo/dom-construct', 'dojo/dom-class', "dojo/text!./Address.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', "jimu/dijit/Popup", 'jimu/dijit/Message', 'dijit/form/ValidationTextBox', "dijit/form/Select", "./layersAndFieldsApplyOn", 'dojo/on'], function (declare, Evented, lang, array, domConstruct, domClass, template, _TemplatedMixin, BaseWidgetSetting, Popup, Message, TextBox, Select, layersAndFieldsApplyOn, on) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    ValidFieldsByTypeToApplyOn: {
      "esriFieldTypeOID": ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble", "esriFieldTypeString"],
      "esriFieldTypeSmallInteger": ["esriFieldTypeSmallInteger", "esriFieldTypeString", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeInteger": ["esriFieldTypeSmallInteger", "esriFieldTypeString", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeDouble": ["esriFieldTypeSmallInteger", "esriFieldTypeString", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
      "esriFieldTypeSingle": ["esriFieldTypeSmallInteger", "esriFieldTypeString", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"],
    ...
    */
    _getFieldsOptionsObj: function _getFieldsOptionsObj(fieldArray) {
      var fieldOptions = [];
      array.forEach(fieldArray, lang.hitch(this, function (field) {
        //Filter fields based on type
        if (field.type !== "esriFieldTypeGeometry" && field.type !== "esriFieldTypeBlob" && field.type !== "esriFieldTypeRaster" && field.type !== "esriFieldTypeXML") {
          fieldOptions.push({
    ...
    */
    _createLayerFieldsFilter: function _createLayerFieldsFilter() {
      var validFieldSet,
          layerDetails = {};
