...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/Evented", "dojo/_base/lang", "dojo/_base/array", "dojo/dom-style", 'dojo/dom-construct', 'dojo/on', 'dojo/query', "dojo/text!./EditFields.html", "./FieldValidation", "./CopyAttributes", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/SimpleTable', "jimu/dijit/Popup", 'esri/lang'], function (declare, Evented, lang, array, domStyle, domConstruct, on, query, template, FieldValidation, CopyAttributes, _TemplatedMixin, BaseWidgetSetting, Table, Popup, esriLang) {
  return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
    ...
    postCreate: function postCreate() {
      ...
      this._fieldValidations = this._configInfo.fieldValidations === undefined ? {} : lang.clone(this._configInfo.fieldValidations);
      this._fieldValues = this._configInfo.fieldValues === undefined ? {} : lang.clone(this._configInfo.fieldValues);
      this._attachmentValidations = this._configInfo.attachmentValidations === undefined ? {} : lang.clone(this._configInfo.attachmentValidations);
    ...
    popupEditPage: function popupEditPage() {
      this.fieldsPopUp = new Popup({
        titleLabel: esriLang.substitute({ layername: this._layerName }, this.nls.fieldsPage.title),
        width: 972,
        maxHeight: 700,
        autoHeight: true,
        content: this,
    ...
    _initFieldsTable: function _initFieldsTable() {
      var fields2 = [{
        name: 'required',
        title: "",
        type: 'text',
      ...
      this.own(on(this._fieldsTable, 'actions-edit', lang.hitch(this, this._onEditFieldInfoClick)));
    },
    _validateTable: function _validateTable() {
    ...
    _onEditFieldInfoClick: function _onEditFieldInfoClick(tr) {
      ...
      var popupTitle = esriLang.substitute({ fieldname: rowData.fieldName }, this.nls.actionPage.smartActionTitle);
    ...
    _onCopyAttrButtonClick: function _onCopyAttrButtonClick(tr) {
      var rowData = this._fieldsTable.getRowData(tr);
      //if (rowData && rowData.isEditable !== null) {
      ////move code below here if wish to disable smart actions on gDB fields
      //'jimu/dijit/Message'Message
    ...
    _onAttachmentsValidationClicked: function _onAttachmentsValidationClicked() {
      //configure popup title
      var popupTitle = esriLang.substitute({ layername: this._layerName }, this.nls.fieldsPage.smartAttachmentPopupTitle);
      var layerDefinition = {
        fields: lang.clone(this._configInfo.layerInfo.layerObject.fields)
      };
    ...
    _addNewAction: function _addNewAction(fieldColumn, tr) {
      var action;
    ...
    _onDisplayFieldChanged: function _onDisplayFieldChanged(tr) {
      var rowData = this._fieldsTable.getRowData(tr);
    ...
    _onIsEditableFieldChanged: function _onIsEditableFieldChanged(tr) {
      var rowData = this._fieldsTable.getRowData(tr);
    ...
    _resetFieldInfos: function _resetFieldInfos() {
    ...
    _getFieldInfoByFieldName: function _getFieldInfoByFieldName(fieldInfos, fieldName) {
      var fieldInfo;
