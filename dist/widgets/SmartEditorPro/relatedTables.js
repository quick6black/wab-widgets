...
define(["dojo/_base/declare", "dojo/Evented", "dojo/on", "dojo/string", "dojo/dom-attr", "dojo/dom-style", "dojo/_base/lang", "dojo/_base/array", "dojo/dom-construct", "esri/graphic", "jimu/dijit/Message", "dijit/_WidgetBase", "./presetUtils", 'dojo/query', "esri/tasks/RelationshipQuery", "dojo/dom-geometry", "dojo/dom-class"], function (declare, Evented, on, String, domAttr, domStyle, lang, array, domConstruct, Graphic, Message, _WidgetBase, presetUtils, query, RelationshipQuery, domGeom, domClass) {
  return declare([_WidgetBase, Evented], {
    ...
    */
     ...
     */
    _getKeyField: function _getKeyField(primaryKeyField) {
    ...
    */
    _createRelatedTableItem: function _createRelatedTableItem(relationship, contentWrapper) {
      var titleContainer,
          tableTitle,
          createNewFeature,
          tableInfo,
      ...
      domAttr.set(titleContainer, "parentFeatureOID", this.parentFeature.attributes[this.parentFeature._layer.objectIdField]);
      ...
      on(titleContainer, "click", lang.hitch(this, function (evt) {
        ...
        if (relatedCount === null || relatedCount && parseInt(relatedCount, 10) !== 0) {
          this.emit("titleClicked", tableInfo.id, relationship.relationshipId, false, this.parentFeatureIndexInAI, this.parentFeature.attributes[this.parentFeature._layer.objectIdField], this.newRelatedFeature[relationship.relationshipId].foreignKeyField);
        }
      }));
      ...
      if (relationShipInfo.isValidRelation) {
        this._createNewGraphics(relationship.relationshipId, tableInfo.id, relationShipInfo.primaryKeyField, relationShipInfo.foreignKeyField);
      ...
      if (this._canAddFeatures(relationship, tableInfo) && tableInfo.layerObject.type === "Table") {
        ...
        on(createNewFeature, "click", lang.hitch(this, function (evt) {
          ...
          if (this.parentFeature.attributes[currentFeature.primaryKeyField] === undefined || this.parentFeature.attributes[currentFeature.primaryKeyField] === null) {
            //Fetch field alias or field name from the field for showing the warning message
            var fieldInfo = presetUtils.getFieldInfoByFieldName(this.parentFieldInfos, currentFeature.primaryKeyField);
            var fieldAlias = fieldInfo.label || currentFeature.primaryKeyField;
            var errorMsg = String.substitute(this.nls.invalidRelationShipMsg, { parentKeyField: fieldAlias });
            Message({
              message: errorMsg
            });
            return;
          ...
          this.newRelatedFeature[relationship.relationshipId].attributes[this.newRelatedFeature[relationship.relationshipId].foreignKeyField] = this.parentFeature.attributes[this.newRelatedFeature[relationship.relationshipId].primaryKeyField];
          this.emit("addRelatedRecord", this.newRelatedFeature[relationship.relationshipId], titleContainer, tableInfo.id, this.parentFeatureIndexInAI, this.newRelatedFeature[relationship.relationshipId].foreignKeyField);
        }));
      }
      if (relationShipInfo.isValidRelation) {
    ...
    */
    _canAddFeatures: function _canAddFeatures(tableConfig, tableInfo) {
    ...
    _checkRelationShip: function _checkRelationShip(tableInfo, relationshipId) {
      var parentLayerRelation,
          relatedLayerRelation,
          primaryKeyField,
          foreignKeyField,
      ...
      if (parentLayerRelation && parentLayerRelation.keyField && relatedLayerRelation && relatedLayerRelation.keyField) {
    ...
    */
    _createNewGraphics: function _createNewGraphics(relationshipId, tableId, primaryKeyField, foreignKeyField) {
      var tableInfo,
          newGraphic,
          featureAttributes = {},
          isValidRelation = true;
    ...
    */
    _getRelationShipById: function _getRelationShipById(layer, relationshipId) {
      var relation;
    ...
    updateFeatureInstance: function updateFeatureInstance(updatedAttributes) {
     ...
     */
    displayRelatedRecordCount: function displayRelatedRecordCount(relatedRecordCount, relationshipid) {
      var countNode, countParent, relatedTableTitleNode, newWidth, createNewIcons, loadingIconNode;
     ...
     */
    updateRelatedRecordsCount: function updateRelatedRecordsCount() {
      array.forEach(this._validRelations, lang.hitch(this, function (relationship) {
        this.getRelatedRecordsCount(relationship.relationshipId, relationship.featureLayer.id);
      }));
    },
     ...
     */
    _showLoadingIndicator: function _showLoadingIndicator(relationshipid) {
      var countNode, countParent, relatedTableTitleNode, newWidth, createNewIcons, loadingIconNode;
      //get nodes by querying
      countParent = query("[relationshipid = " + relationshipid + "]", this.domNode);
      createNewIcons = query(".relatedTableIcons.itemTitleCreateNew", this.domNode);
     ...
     */
    getRelatedRecordsCount: function getRelatedRecordsCount(relationshipId, relatedLayersId) {
