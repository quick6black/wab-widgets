...
define(['dojo/_base/declare', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./BasemapItem.html', 'dojo/Evented', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'esri/SpatialReference', 'jimu/utils', './utils'], function (declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Evented, lang, html, on, SpatialReference, jimuUtils, utils) {
  var MODE_READONLY = 0,
      MODE_EDIT = 1,
      MODE_SELECT = 2;
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    updateItem: function updateItem(newBasemap) {
      this.basemap = newBasemap;
      html.setStyle(this.thumbnailElement, 'backgroundImage', "url(" + this.basemap.thumbnailUrl + ")");
    ...
    _createItem: function _createItem() {
      ...
      if (reg.test(this.basemap.thumbnailUrl)) {
        ...
        if (this.mode !== MODE_READONLY) {
          ...
          html.setStyle(this.thumbnailElement, 'backgroundImage', "url(" + thumbnailUrl + ")");
        }
      }
      ...
      if (!this.spatialReference.equals(new SpatialReference(+this.basemap.spatialReference.wkid))) {
