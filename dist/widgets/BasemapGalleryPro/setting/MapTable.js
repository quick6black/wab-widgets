...
define(['dojo/_base/declare', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./MapTable.html', 'dojo/Evented', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/Deferred', 'dojo/promise/all', 'dojo/query', 'dojo/on', 'esri/request', 'jimu/utils', 'jimu/portalUtils', 'jimu/portalUrlUtils', 'jimu/dijit/LoadingIndicator', '../BasemapItem', '../utils'], function (declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, Evented, lang, array, html, Deferred, all, query, on, esriRequest, jimuUtils, portalUtils, portalUrlUtils, LoadingIndicator, BasemapItem, utils) {
  /* jshint unused: false */
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    search: function search(newQuery) {
      if (newQuery) {
    ...
    _filterMapCallback: function _filterMapCallback() {
    ...
    _createMapItems: function _createMapItems(response) {
      var _basemapAll = [],
          _requestAll = [],
          retDef = new Deferred();
      ...
      all(_basemapAll).then(lang.hitch(this, function (basemapInfos) {
        array.forEach(basemapInfos, lang.hitch(this, function (basemap) {
          ...
          utils.isBasemapCompatibleWithMap(basemap.spatialReference, basemap.layers, this.map).then(lang.hitch(this, function (compatible) {
            if (compatible) {
    ...
    _createMapItem: function _createMapItem(basemap) {
    ...
    getSelectedMapItems: function getSelectedMapItems() {
