define(['dojo/Evented', 'dojo/_base/declare', 'dojo/Deferred', 'dojo/_base/html', 'dojo/has', 'jimu/utils'], function (Evented, declare, Deferred, html, has, jimuUtils) {
  return declare([Evented], {
    ...
    exportsJson: function exportsJson(filename, json) {
