...
///////////////////////////////////////////////////////////////////////////
define(['dojo/Evented', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/Deferred', 'dojo/promise/all', 'esri/request'], function (Evented, declare, lang, array, Deferred, all, esriRequest) {
  return declare([Evented], {
    ...
    getAllMapLayers: function getAllMapLayers() {
      var promises = [];
      ...
      array.forEach(this.layers, lang.hitch(this, function (layer) {
        if (!layer.featureCollection) {
          if (typeof layer.originOperLayer !== 'undefined' && layer.originOperLayer.layerType && (layer.originOperLayer.layerType === 'ArcGISFeatureLayer' || layer.originOperLayer.layerType === 'ArcGISImageServiceLayer')) {
    ...
    _getLayerInfo: function _getLayerInfo(dataitem) {
      var deferred = new Deferred();
      if (!dataitem.url) {
        deferred.resolve();
    ...
    _controlComplete: function _controlComplete() {
