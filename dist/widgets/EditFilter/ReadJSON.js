define(['dojo/Evented', 'dojo/_base/declare', 'dojo/has', 'dojo/_base/lang', 'jimu/utils', 'jimu/dijit/Message'], function (Evented, declare, has, lang, utils, Message) {
  return declare([Evented], {
    ...
    checkFileReader: function checkFileReader() {
    ...
    _processFiles: function _processFiles(files) {
      if (files.length > 0) {
        var file = files[0];
    ...
    handleJson: function handleJson(file) {
    ...
    supportHTML5: function supportHTML5() {
    ...
    supportFileAPI: function supportFileAPI() {
    ...
    isEnabledFlash: function isEnabledFlash() {
      var swf = null;
      if (document.all) {
        try {
          /* jshint ignore:start */
    ...
    completePrompt: function completePrompt(pSettings) {
      this.emit("complete", { 'UserSettings': pSettings });
    },

    errorPrompt: function errorPrompt() {
