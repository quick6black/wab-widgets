...
define(['dojo/_base/declare', 'jimu/BaseWidgetSetting', 'jimu/dijit/FilterParameters', 'dijit/_WidgetsInTemplateMixin', 'dojo/on', 'dojo/dom-construct', 'dojo/dom-attr', 'dojo/query', 'dojo/_base/lang', 'dojo/_base/array', 'dijit/form/Select', 'esri/layers/FeatureLayer', 'dojo/text!./presetValuePicker.html'], function (declare, BaseWidgetSetting, FilterParameters, _WidgetsInTemplateMixin, on, domConstruct, domAttr, query, lang, array, Select, FeatureLayer, template) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    createLayerSelection: function createLayerSelection() {
      var ctlLayerList = [];
    ...
    createFieldSelection: function createFieldSelection(pLayer) {
      var ctlfieldList = [];
    ...
    createValueList: function createValueList(pVal, pLayer) {
    ...
    _makefilterObject: function _makefilterObject(fieldObj) {
      var filter = {};
      var parts = [];
      var partsObj = {};
      partsObj.fieldObj = {};
