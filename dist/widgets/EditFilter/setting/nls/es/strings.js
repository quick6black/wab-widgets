define({
  ...
  "labels": {
    ...
    "sameLayerAppend": "Si una capa aparece más de una vez, utilizar el operador siguiente entre campos:",
  ...
  "inputs": {
    ...
    "webmapAppendMode": "Incorporar filtro a filtro de mapa web existente utilizando ",
    "webmapAppendModeTip": "Opción que permite incorporar el conjunto de filtros al filtro de un mapa web existente. Los operadores compatibles son OR y AND.",
