define({
  ...
  "labels": {
    ...
    "sameLayerAppend": "레이어가 둘 이상 나열되는 경우 필드 사이에 다음 연산자를 사용하세요.",
  ...
  "inputs": {
    ...
    "webmapAppendMode": "기존 웹 맵 필터를 사용하여 추가 필터링 ",
    "webmapAppendModeTip": "필터 설정을 기존 웹 맵 필터에 추가하는 옵션입니다. 지원되는 연산자는 OR과 AND입니다.",
