define({
  ...
  "labels": {
    ...
    "sameLayerAppend": "Quando uma camada é listada mais do que uma vez, utilize o seguinte operador entre filtros:",
  ...
  "inputs": {
    ...
    "webmapAppendMode": "Anexar Filtro a Filtro de Mapa Web Existente Utilizando ",
    "webmapAppendModeTip": "Opção para anexar o conjunto de filtros a um filtro de mapas web existente. Os operadores suportados são OU e E.",
