...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/on', 'dojo/has', './MobilePopup', 'dojo/dom', 'dojo/dom-construct', 'dojo/dom-style', 'dojo/dom-class', 'dojo/dom-attr', 'dojo/_base/array', 'dojo/Evented', 'esri/graphic', 'esri/SpatialReference', 'esri/geometry/Polyline', 'dojo/sniff'], function (declare, lang, html, on, has, MobilePopup, dom, domConstruct, domStyle, domClass, domAttr, array, Evented, Graphic, SpatialReference, Polyline) {
  return declare([MobilePopup, Evented], {
    ...
    _dataMixin: function _dataMixin() {
