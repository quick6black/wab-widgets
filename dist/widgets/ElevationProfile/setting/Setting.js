...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/on', 'dojo/_base/query', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'esri/units', 'esri/tasks/LinearUnit', 'dojo/_base/Color', 'dojo/colors', 'dojo/fx/easing', 'dojox/charting/Chart', 'dojox/charting/axis2d/Default', 'dojox/charting/plot2d/Grid', 'dojox/charting/plot2d/Areas', 'dojox/charting/action2d/MouseIndicator', 'dojox/charting/action2d/TouchIndicator', 'dojox/charting/themes/ThreeD', 'esri/sniff', 'dojo/_base/Deferred', 'esri/dijit/Measurement', './SymbologyEdit', './ChartEdit', 'dojo/number', 'jimu/dijit/SymbolPicker', 'jimu/dijit/Popup', 'dojo/keys', 'jimu/dijit/ServiceURLInput', 'dijit/form/Select', 'dijit/form/NumberTextBox'], function (declare, lang, array, html, on, query, _WidgetsInTemplateMixin, BaseWidgetSetting, units, LinearUnit, Color, colors, easing, Chart, Default, Grid, Areas, MouseIndicator, TouchIndicator, ThreeD, esriSniff, Deferred, Measurement, SymbologyEdit, ChartEdit, number, SymbolPicker, Popup, keys) {
        return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
                ...
                _onServiceFetchError: function _onServiceFetchError() {
                ...
                _onServiceFetch: function _onServiceFetch(urlDijit, evt) {
                        var result = false;
                ...
                _onServiceUrlChange: function _onServiceUrlChange() {
                        this._checkProceed();
                },

                _checkProceed: function _checkProceed() {
                        var canProceed = true;
                ...
                _bindEvents: function _bindEvents() {
                        ...
                        this.urlTextBox.setProcessFunction(lang.hitch(this, '_onServiceFetch', this.urlTextBox), lang.hitch(this, '_onServiceFetchError'));
                ...
                _onSymEditOk: function _onSymEditOk() {
                        this.config.symbols = this.popupsymedit.getConfig().symbols;
                        this.popup.close();
                        this.popupState = '';
                },

                _onSymEditClose: function _onSymEditClose() {
                        this.popupsymedit = null;
                        this.popup = null;
                },

                _openSymEdit: function _openSymEdit(title) {
                ...
                _onChartEditOk: function _onChartEditOk() {
                ...
                _onChartEditClose: function _onChartEditClose() {
                        this.popupchartedit = null;
                        this.popup2 = null;
                },

                _openChartEdit: function _openChartEdit(title) {
