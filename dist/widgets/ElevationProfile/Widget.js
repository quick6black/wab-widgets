...
define(['dojo/_base/declare', 'jimu/BaseWidget', 'dojo/Evented', 'dijit/_OnDijitClickMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/on', 'dojo/aspect', 'dojo/_base/lang', 'dojo/_base/Deferred', 'dojo/_base/array', 'dojo/number', 'dijit/registry', 'put-selector/put', 'dojo/dom-class', 'dojo/_base/Color', 'dojo/colors', 'dojox/charting/Chart', 'dojox/charting/axis2d/Default', 'dojox/charting/plot2d/Grid', 'dojox/charting/plot2d/Areas', 'dojox/charting/action2d/MouseIndicator', 'dojox/charting/action2d/TouchIndicator', 'dojox/charting/themes/ThreeD', 'esri/sniff', 'esri/request', 'esri/tasks/Geoprocessor', 'esri/geometry/Polyline', 'esri/symbols/SimpleLineSymbol', 'esri/symbols/SimpleMarkerSymbol', 'esri/graphic', 'esri/tasks/FeatureSet', 'esri/tasks/LinearUnit', 'esri/geometry/geodesicUtils', 'esri/geometry/webMercatorUtils', 'esri/units', 'jimu/utils', 'esri/dijit/Measurement', 'dojo/_base/html', 'dijit/ProgressBar', 'jimu/dijit/TabContainer', 'jimu/dijit/Message', 'dojo/dom-construct', 'dojox/gfx/utils', 'esri/config', 'esri/tasks/ProjectParameters', 'esri/SpatialReference', 'jimu/BaseFeatureAction', 'jimu/dijit/FeatureActionPopupMenu', 'jimu/CSVUtils', 'esri/layers/GraphicsLayer', './SegmentChooser', 'jimu/WidgetManager', 'jimu/PanelManager', 'jimu/dijit/LoadingShelter'], function (declare, BaseWidget, Evented, _OnDijitClickMixin, _WidgetsInTemplateMixin, on, aspect, lang, Deferred, array, number, registry, put, domClass, Color, colors, Chart, Default, Grid, Areas, MouseIndicator, TouchIndicator, ThreeD, esriSniff, esriRequest, Geoprocessor, Polyline, SimpleLineSymbol, SimpleMarkerSymbol, Graphic, FeatureSet, LinearUnit, geodesicUtils, webMercatorUtils, Units, jimuUtils, Measurement, html, ProgressBar, TabContainer, Message, domConstruct, gfxUtils, esriConfig, ProjectParameters, SpatialReference, BaseFeatureAction, PopupMenu, CSVUtils, GraphicsLayer, SegmentChooser, WidgetManager, PanelManager) {
  return declare([BaseWidget, _OnDijitClickMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    postCreate: function postCreate() {
      ...
      this.own(aspect.after(registry.getEnclosingWidget(this.domNode), 'resize', lang.hitch(this, this._resizeChart), true));
    ...
    _onBtnMenuClicked: function _onBtnMenuClicked(evt) {
     ...
     * @private
     */
    _initMeasureTool: function _initMeasureTool() {
      // MEASUREMENT TOOL //
     ...
     * @private
     */
    _onMeasureClick: function _onMeasureClick() {
    ...
    _onMeasureEnd: function _onMeasureEnd(evt) {
    ...
    openWidgetandProfileLine: function openWidgetandProfileLine(feat) {
      if (this.inPanel) {
        var panel = this.getPanel();
    ...
    _profileLine: function _profileLine(feat) {
      this.eFeatGL.clear();
      this.tabContainer.selectTab(this.nls.resultslabel);
      this.map.infoWindow.hide();
      this.clearProfileChart();
    ...
    _linePathChoosen: function _linePathChoosen(pLine) {
    ...
    _downloadCanvas: function _downloadCanvas(link, canvas, filename) {
     ...
     * @private
     */
    _initProfileService: function _initProfileService() {
     ...
     * @private
     */
    _getProfile: function _getProfile(polyline) {
      var deferred = new Deferred();
     ...
     * @returns {*}
     */
    displayProfileChart: function displayProfileChart(geometry) {
      html.setStyle(this.divOptions, 'display', 'none');
      html.setStyle(this.btnDownload, 'display', 'none');
     ...
     * @private
     */
    clearProfileChart: function clearProfileChart() {
     ...
     * @private
     */
    _updateProfileChart: function _updateProfileChart() {
      html.setStyle(this.divOptions, 'display', 'none');
      html.setStyle(this.progressBar.domNode, 'display', 'block');
    ...
    _unitsChanged: function _unitsChanged() {
    ...
    _flipProfile: function _flipProfile() {
     ...
     * @private
     */
    _createProfileChart: function _createProfileChart(elevationInfo) {
      var deferred = new Deferred();
     ...
     */
    _displayChartLocation: function _displayChartLocation(chartObjectX) {
     ...
     */
    _getDisplayValue: function _getDisplayValue(valueMeters, displayUnits) {
     ...
     */
    _getDisplayUnits: function _getDisplayUnits(isElevation) {
     ...
     * @private
     */
    _convertElevationsInfoArray: function _convertElevationsInfoArray(elevationArray) {
     ...
     * @private
     */
    _convertDistancesArray: function _convertDistancesArray(distancesArray) {
      var displayUnitsX = this._getDisplayUnits(false);
     ...
     * @private
     */
    _getFilledArray: function _getFilledArray(size, value, asMultiplier) {
     ...
     * @private
     */
    _resetArray: function _resetArray(dataArray, value) {
     ...
     * @private
     */
    _getArrayMax: function _getArrayMax(dataArray) {
     ...
     * @private
     */
    _getArrayMin: function _getArrayMin(dataArray) {
      var values = array.map(dataArray, function (item) {
        return item.y;
      });
