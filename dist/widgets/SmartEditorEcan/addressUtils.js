...
define(["dojo/_base/declare", "dojo/_base/lang", 'dojo/Deferred', "dojo/on", "esri/tasks/locator", "dijit/_WidgetBase"], function (declare, lang, Deferred, on, Locator, _WidgetBase) {
  return declare([_WidgetBase], {
    ...
    _initReverseGeocoder: function _initReverseGeocoder() {
      if (this.config.geocoderSettings && this.config.geocoderSettings.url) {
        ...
        this.own(on(this._locatorInstance, "location-to-address-complete", lang.hitch(this, this._onLocationToAddressComplete)));
        this.own(on(this._locatorInstance, "error", lang.hitch(this, function () {
          this._onLocationToAddressComplete({});
        })));
      }
    },

    locateAddress: function locateAddress(geometry) {
    ...
    _onLocationToAddressComplete: function _onLocationToAddressComplete(result) {
