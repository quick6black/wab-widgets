...
define(['dojo/_base/declare', 'dojo/_base/array', 'dojo/_base/lang', 'dojo/Deferred', 'jimu/BaseFeatureAction', 'jimu/Role', 'jimu/WidgetManager'], function (declare, array, lang, Deferred, BaseFeatureAction, Role, WidgetManager) {
  var clazz = declare(BaseFeatureAction, {
    ...
    isFeatureSupported: function isFeatureSupported(featureSet, layerParam) {
      ...
      if (layerHasBeenConfiged && layer.isEditable && layer.isEditable()) {
    ...
    onExecute: function onExecute(featureSet, layerParam) {
      ...
      WidgetManager.getInstance().triggerWidgetOpen(this.widgetId).then(function (smartEditor) {
        smartEditor.beginEditingByFeatures(featureSet.features, layer);
      });
      return def.promise;
    },
