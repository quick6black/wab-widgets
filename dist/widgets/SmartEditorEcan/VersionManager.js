                ...
                if (newConfig.editor.layerInfos[i].hasOwnProperty("fieldInfos")) {
                  if (newConfig.editor.layerInfos[i].fieldInfos.length > 0) {
                    for (var j = 0; j < newConfig.editor.layerInfos[i].fieldInfos.length; j++) {
                      if (newConfig.editor.layerInfos[i].fieldInfos[j].hasOwnProperty("isEditable") === true && newConfig.editor.layerInfos[i].fieldInfos[j].hasOwnProperty("visible") === true) {
                        if (newConfig.editor.layerInfos[i].fieldInfos[j].isEditable === true && newConfig.editor.layerInfos[i].fieldInfos[j].visible === false) {
