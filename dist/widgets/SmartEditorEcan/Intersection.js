define(["dojo/_base/declare", "dojo/_base/lang", "dojo/Deferred", "jimu/BaseWidgetSetting", "esri/tasks/query", "esri/tasks/QueryTask", "esri/geometry/Extent"], function (declare, lang, Deferred, BaseWidgetSetting, Query, QueryTask, Extent) {
  return declare([BaseWidgetSetting], {
    ...
    _getIntersectionsForEachField: function _getIntersectionsForEachField(distinctLayers, featureGeometry) {
    ...
    _intersectionResult: function _intersectionResult(result, fieldDef) {
      ...
      if (result.layerId) {
        this.layerFieldsObj[result.layerId] = result.features && result.features.length > 0 ? result.featuresAttributes : {};
      }
      fieldDef.resolve();
    },
    ...
    _getAppropriateGeometryForQuery: function _getAppropriateGeometryForQuery(featureGeometry) {
      var returGeometry;
