...
define(['dojo/_base/lang', 'dojo/Deferred', 'esri/geometry/webMercatorUtils', 'esri/SpatialReference'], function (lang, Deferred, webMercatorUtils, SpatialReference) {
  ...
  mo.getCoordinatesData = function (geometry, geometryService) {
    ...
    mo.getProjectedGeometry(coordinatesInfo.MapSpatialReference, latLongSpatialRef, geometryService).then(lang.hitch(this, function (latLongCoordinates) {
