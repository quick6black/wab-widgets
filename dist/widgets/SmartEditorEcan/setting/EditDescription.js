...
define(["dojo/_base/declare", "dojo/_base/lang", 'dojo/on', 'dojo/query', "dojo/text!./EditDescription.html", 'dijit/_TemplatedMixin', 'jimu/BaseWidgetSetting', 'dijit/Editor', "jimu/dijit/Popup", 'esri/lang', 'dojo/sniff', 'jimu/utils', 'dojo/_base/html', 'dijit/_editor/plugins/LinkDialog', 'dijit/_editor/plugins/ViewSource', 'dijit/_editor/plugins/FontChoice', 'dojox/editor/plugins/Preview', 'dijit/_editor/plugins/TextColor', 'dojox/editor/plugins/ToolbarLineBreak', 'dojox/editor/plugins/FindReplace', 'dojox/editor/plugins/PasteFromWord', 'dojox/editor/plugins/InsertAnchor', 'dojox/editor/plugins/Blockquote', 'dojox/editor/plugins/UploadImage', 'jimu/dijit/EditorChooseImage', 'jimu/dijit/EditorTextColor', 'jimu/dijit/EditorBackgroundColor'], function (declare, lang, on, query, template, _TemplatedMixin, BaseWidgetSetting, Editor, Popup, esriLang, has, utils, html) {
  return declare([BaseWidgetSetting, _TemplatedMixin], {
    ...
    popupEditDescription: function popupEditDescription() {
      ...
      var editDescPopup = new Popup({
        titleLabel: esriLang.substitute({ layername: this._layerName }, this.nls.editDescriptionPage.title),
        width: 720,
        maxHeight: 700,
        autoHeight: true,
        content: this,
    ...
    _initEditor: function _initEditor() {
      if (!this._editorObj) {
        ...
        this.own(on(this._editorObj, "blur", lang.hitch(this, function () {})));
