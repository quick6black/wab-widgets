define(["dojo", "dijit", "dijit/_editor/_Plugin", "jimu/dijit/ImageChooser", "dojo/_base/html", "dojo/_base/connect", "dojo/_base/declare", "dojox/form/FileUploader"], function (dojo, dijit, _Plugin, ImageChooser, html) {
  ...
  var ChooseImage = dojo.declare("dojox.editor.plugins.ChooseImage", _Plugin, {
    ...
    onComplete: function onComplete(data /*,ioArgs,widgetRef*/) {
      data = data[0];
    ...
    insertTempImage: function insertTempImage(fileData) {
      // summary:
