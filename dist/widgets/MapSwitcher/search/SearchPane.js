...
///////////////////////////////////////////////////////////////////////////
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/on", "dojo/dom-class", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dojo/text!./templates/SearchPane.html", "dojo/i18n!../nls/strings", "./SearchBox", "./ScopeOptions", "./SortOptions", "./ResultsPane", "./Paging", "./ResultCount"], function (declare, lang, array, on, domClass, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, i18n) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    getComponents: function getComponents() {
      return [this.searchBox, this.scopeOptions, this.sortOptions, this.resultsPane, this.paging, this.resultCount];
    },
