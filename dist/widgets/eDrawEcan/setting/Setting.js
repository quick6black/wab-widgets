...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/html', 'dojo/_base/query', 'dojo/on', 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidgetSetting', 'jimu/dijit/TabContainer', 'jimu/utils', 'dijit/form/Select', 'jimu/dijit/CheckBox', 'jimu/dijit/SimpleTable', 'jimu/dijit/Message'], function (declare, lang, array, html, query, on, _WidgetsInTemplateMixin, BaseWidgetSetting, TabContainer, jimuUtils, Select, CheckBox, SimpleTable, Message) {
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    localStorageKeyMessage: function localStorageKeyMessage() {
      new Message({
    ...
    _setTextPlusFontFamilyTable: function _setTextPlusFontFamilyTable(config) {
      var options = config.drawPlus && config.drawPlus.fontFamilies && config.drawPlus.fontFamilies.length > 0 ? config.drawPlus.fontFamilies : [{
        "label": "Arial",
        "value": "Arial"
      }, {
        "label": "Helvetica",
    ...
    _setDistanceTable: function _setDistanceTable(distanceUnits) {
    ...
    _setAreaTable: function _setAreaTable(areaUnits) {
    ...
    getConfig: function getConfig() {
      ...
      if (!config["drawPlus"]) config["drawPlus"] = {};
    ...
    _getDistanceConfig: function _getDistanceConfig() {
      var result = [];
    ...
    _getAreaConfig: function _getAreaConfig() {
      var result = [];
    ...
    _getAllDistanceUnitValues: function _getAllDistanceUnitValues() {
    ...
    _getUsedDistanceUnitValues: function _getUsedDistanceUnitValues() {
      var trs = this.distanceTable.getRows();
    ...
    _getNotUsedDistanceUnitValues: function _getNotUsedDistanceUnitValues() {
    ...
    _getDistanceUnitInfo: function _getDistanceUnitInfo(value) {
      var result = null;
    ...
    _addFontFamily: function _addFontFamily() {
      ...
      if (result) this.textPlusFontFamilyTable.editRow(result.tr, data);
    },

    _addDistance: function _addDistance() {
    ...
    _checkStatusForBtnAddDistance: function _checkStatusForBtnAddDistance() {
      var notUsedValues = this._getNotUsedDistanceUnitValues();
      if (notUsedValues.length === 0) {
    ...
    _addDistanceUnitRow: function _addDistanceUnitRow(unitInfo) {
      var rowData = {
        abbr: unitInfo.abbr,
    ...
    _showCorrectDistanceInfoBySelectedOption: function _showCorrectDistanceInfoBySelectedOption(tr) {
      var select = tr.select;
    ...
    _resetDistanceSelectOptions: function _resetDistanceSelectOptions() {
      var trs = this.distanceTable.getRows();
    ...
    _getAllAreaUnitValues: function _getAllAreaUnitValues() {
    ...
    _getUsedAreaUnitValues: function _getUsedAreaUnitValues() {
      var trs = this.areaTable.getRows();
    ...
    _getNotUsedAreaUnitValues: function _getNotUsedAreaUnitValues() {
    ...
    _getAreaUnitInfo: function _getAreaUnitInfo(value) {
      var result = null;
    ...
    _checkStatusForBtnAddArea: function _checkStatusForBtnAddArea() {
      var notUsedValues = this._getNotUsedAreaUnitValues();
      if (notUsedValues.length === 0) {
    ...
    _addAreaUnitRow: function _addAreaUnitRow(unitInfo) {
      var rowData = {
        abbr: unitInfo.abbr,
        conversion: unitInfo.conversion
      };
    ...
    _showCorrectAreaInfoBySelectedOption: function _showCorrectAreaInfoBySelectedOption(tr) {
      var select = tr.select;
    ...
    _resetAreaSelectOptions: function _resetAreaSelectOptions() {
      var trs = this.areaTable.getRows();
      var selects = array.map(trs, lang.hitch(this, function (tr) {
        return tr.select;
      }));
