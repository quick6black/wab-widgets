...
define(["dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/on", "./SearchComponent", "dojo/text!./templates/TypeOptions.html", "dojo/i18n!../nls/strings", "esri/layers/VectorTileLayer", "dijit/TooltipDialog", "dijit/form/DropDownButton", "dijit/form/CheckBox"], function (declare, array, lang, on, SearchComponent, template, i18n, VectorTileLayer) {
  ...
  return declare([SearchComponent], {
    ...
    getOptionWidgets: function getOptionWidgets() {
      return [this.mapServiceToggle, this.featureServiceToggle, this.imageServiceToggle, this.vectorTileServiceToggle, this.kmlToggle, this.wmsToggle];
    },
