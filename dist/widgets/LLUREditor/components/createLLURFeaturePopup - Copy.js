define(["dojo/_base/declare", "jimu/BaseWidgetSetting", "dijit/_WidgetsInTemplateMixin", "dijit/form/DropDownButton", "dijit/DropDownMenu", "dijit/MenuItem", "dojo/_base/lang", 'dojo/_base/array', "dojo/text!./templates/CreateLLURFeaturePopup.html", "jimu/dijit/Popup", "dojo/dom-construct", 'dojo/dom-style'], function (declare, BaseWidgetSetting, _WidgetsInTemplateMixin, DropDownButton, DropDownMenu, MenuItem, lang, arrayUtils, CreateLLLURFeatureTemplate, Popup, domConstruct, domStyle) {
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    startup: function startup() {
      ...
      if (this.wabWidget && this.wabWidget.recordTemplateLayers) {
        ...
        arrayUtils.forEach(this.wabWidget.recordTemplateLayers, function (option) {
          var menuParams = {
            label: option.title,
            template: option
          };
    ...
    **/
    _createCreateLLURFeaturePopup: function _createCreateLLURFeaturePopup() {
      //creating ok button
    ...
    getSelectedRecordType: function getSelectedRecordType() {
      return this.selecteTemplate;
    },

    _optionsClick: function _optionsClick(templateOption) {
