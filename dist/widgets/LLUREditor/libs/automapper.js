    ...
    (function (AutoMapperJs) {
        ...
        var AutoMapperHelper = function () {
            ...
            AutoMapperHelper.getMappingMetadataFromTransformationFunction = function (destination, func, sourceMapping) {
                ...
                var source = sourceMapping ? destination : AutoMapperHelper.getMapFromString(functionStr, destination, optsParamName);
                var metadata = {
                    destination: destination,
                    source: source,
            ...
            AutoMapperHelper.getIgnoreFromString = function (functionString, optionsParameterName) {
                ...
                return ignoreString === null || ignoreString === '' ? true // <optionsParameterName>.ignore()
            ...
            AutoMapperHelper.getConditionFromFunction = function (func, sourceProperty) {
                ...
                var configFuncOptions = {
                    ...
                    condition: function condition(predicate) {
                        _condition = predicate;
                    },
                    mapFrom: function mapFrom(sourcePropertyName) {
                        // do nothing
                    },
    ...
    (function (AutoMapperJs) {
        ...
        var AutoMapperValidator = function () {
            ...
            AutoMapperValidator.assertMappingConfiguration = function (mapping, strictMode) {
                ...
                var tryHandle = function tryHandle(errorMessage) {
                    if (errorMessage) {
            ...
            AutoMapperValidator.validatePropertyMapping = function (propertyMapping, member, srcObj, dstObj) {
                ...
                return destinationProperty.sourceMapping ? AutoMapperValidator.validateSourcePropertyMapping(propertyMapping, destinationProperty, member, srcObj, dstObj) : AutoMapperValidator.validateDestinationPropertyMapping(propertyMapping, destinationProperty, member, srcObj, dstObj);
            };
    ...
    (function (AutoMapperJs) {
        ...
        var AutoMapperBase = function () {
            ...
            AutoMapperBase.prototype.createDestinationObject = function (destinationType) {
                ...
                return destinationType ? new destinationType() : {};
            };
            ...
            AutoMapperBase.prototype.handlePropertyWithAutoMapping = function (mapping, sourceObject, sourcePropertyName, destinationObject, autoMappingCallbackFunction) {
                ...
                if (_typeof(destinationObject[sourcePropertyName]) === 'object' && destinationObject[sourcePropertyName]) {
                    isNestedObject = destinationObject[sourcePropertyName].constructor.name !== 'Object';
                    if (isNestedObject) {
                        this.createMap(sourceObject[sourcePropertyName].constructor.name, destinationObject[sourcePropertyName].constructor.name).convertToType(destinationObject[sourcePropertyName].constructor);
    ...
    (function (AutoMapperJs) {
        ...
        var AsyncAutoMapper = function (_super) {
            ...
            AsyncAutoMapper.prototype.createMapForMember = function (mapping, property) {
                var _this = this;
                mapping.async = true;
                mapping.mapItemFunction = function (m, srcObj, dstObj, cb) {
                    return _this.mapItem(m, srcObj, dstObj, cb);
                };
                // property.async = true;
            ...
            AsyncAutoMapper.prototype.createMapConvertUsing = function (mapping, converterFunction) {
                ...
                mapping.mapItemFunction = function (m, srcObj, dstObj, cb) {
                    return _this.mapItemUsingTypeConverter(m, srcObj, dstObj, cb);
                };
            };
            AsyncAutoMapper.prototype.map = function (mappings, sourceKey, destinationKey, sourceObject, callback) {
                ...
                switch (arguments.length) {
                    ...
                    case 4:
                        return function (cb) {
                            return _this.mapWithMapping(_super.prototype.getMapping.call(_this, mappings, sourceKey, destinationKey), sourceObject, cb);
                        };
                    case 3:
                        return function (srcObj, cb) {
                            return _this.mapWithMapping(_super.prototype.getMapping.call(_this, mappings, sourceKey, destinationKey), srcObj, cb);
                        };
                    case 2:
                        return function (dstKey, srcObj, cb) {
                            return _this.map(mappings, sourceKey, dstKey, srcObj, cb);
                        };
                    default:
            ...
            AsyncAutoMapper.prototype.mapArray = function (mapping, sourceArray, callback) {
                ...
                var waitForCallbackToSend = function waitForCallbackToSend() {
                    if (callbacksToGo === 0) {
        ...
        var AutoMapper = function (_super) {
            ...
            AutoMapper.prototype.initialize = function (configFunction) {
                ...
                var configuration = {
                    ...
                    createMap: function createMap(sourceKey, destinationKey) {
            ...
            AutoMapper.prototype.map = function (sourceKeyOrType, destinationKeyOrType, sourceObject) {
                ...
                if (arguments.length === 2) {
                    return function (srcObj) {
                        return _this.mapInternal(_super.prototype.getMapping.call(_this, _this._mappings, sourceKeyOrType, destinationKeyOrType), srcObj);
                    };
                }
                if (arguments.length === 1) {
                    return function (dstKey, srcObj) {
                        return _this.map(sourceKeyOrType, dstKey, srcObj);
                    };
                }
                return function (srcKey, dstKey, srcObj) {
                    return _this.map(srcKey, dstKey, srcObj);
                };
            };
            /**
            ...
            AutoMapper.prototype.createMapConvertUsing = function (mapping, tcClassOrFunc) {
                var _this = this;
                var configureSynchronousConverterFunction = function configureSynchronousConverterFunction(converterFunc) {
                    ...
                    mapping.mapItemFunction = function (m, srcObj, dstObj) {
                        return _this.mapItemUsingTypeConverter(m, srcObj, dstObj);
                    };
                };
                try {
            ...
            AutoMapper.prototype.createMappingObjectForGivenKeys = function (srcKeyOrType, dstKeyOrType) {
                ...
                var mapping = {
                    ...
                    mapItemFunction: function mapItemFunction(m, srcObj, dstObj) {
                        return _this.mapItem(m, srcObj, dstObj);
                    },
            ...
            AutoMapper.prototype.createMapGetFluentApiFunctions = function (mapping) {
                ...
                var fluentFunc = {
                    forMember: function forMember(prop, valFunc) {
                    ...
                    forSourceMember: function forSourceMember(prop, cfgFunc) {
                    ...
                    forAllMembers: function forAllMembers(func) {
                        return _this.createMapForAllMembers(mapping, fluentFunc, func);
                    },
                    ignoreAllNonExisting: function ignoreAllNonExisting() {
                        return _this.createMapIgnoreAllNonExisting(mapping, fluentFunc);
                    },
                    convertToType: function convertToType(type) {
                        return _this.createMapConvertToType(mapping, fluentFunc, type);
                    },
                    convertUsing: function convertUsing(tcClassOrFunc) {
                        return _this.createMapConvertUsing(mapping, tcClassOrFunc);
                    },
                    withProfile: function withProfile(profile) {
                        return _this.createMapWithProfile(mapping, profile);
                    }
                };
                return fluentFunc;
            };
            AutoMapper.prototype.createMapForMember = function (parameters) {
                var mapping = parameters.mapping,
                    propertyName = parameters.propertyName,
                    transformation = parameters.transformation,
                    sourceMapping = parameters.sourceMapping,
                    fluentFunctions = parameters.fluentFunctions;
            ...
            AutoMapper.prototype.mergeSourceProperty = function (property, existingProperties, sourceMapping) {
                ...
                var existing = sourceMapping ? this.findProperty(property.name, existingProperties) : this.matchSourcePropertyByDestination(property, existingProperties);
                if (!existing) {
                    return false;
                }
            ...
            AutoMapper.prototype.handleMapFromProperties = function (property, existingProperty) {
                if (property.destinationPropertyName === property.sourcePropertyName || property.sourcePropertyName === existingProperty.sourcePropertyName) {
                    return false;
                }
            ...
            AutoMapper.prototype.mergeDestinationProperty = function (destination, existingDestination, swapTransformations) {
                if (swapTransformations === void 0) {
                    swapTransformations = false;
                }
                ...
                if (existingDestination.sourceMapping !== destination.sourceMapping && existingDestination.sourcePropertyName !== destination.sourcePropertyName) {
        ...
        var CamelCaseNamingConvention = function () {
            ...
            CamelCaseNamingConvention.prototype.transformPropertyName = function (sourcePropertyNameParts) {
                ...
                for (var index = 0, length = sourcePropertyNameParts.length; index < length; index++) {
                    if (index === 0) {
                        result += sourcePropertyNameParts[index].charAt(0).toLowerCase() + sourcePropertyNameParts[index].substr(1);
                    } else {
                        result += sourcePropertyNameParts[index].charAt(0).toUpperCase() + sourcePropertyNameParts[index].substr(1);
                    }
                }
                return result;
            };
