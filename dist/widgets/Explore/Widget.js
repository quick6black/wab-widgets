define(['dojo/_base/declare', 'dojo/_base/lang', 'jimu/BaseWidget', 'esri/config', './widgets/Search/widget', './widgets/BreadcrumbWidget/widget', './widgets/Result/widget', './js/RetrieveWebMapSearchItems', './js/RetrieveWebMapGroups', './js/RetrieveWebMapGroupItems', './js/QueryResultToResultsList', './js/PortalItemFactory', './js/LaunchItem', './js/Show', './js/InViewPort', 'xstyle/css!./css/bootstrap3_3_7.css'], function (declare, lang, BaseWidget, esriConfig, SearchWidget, BreadCrumbWidget, Results, RetrieveWebMapSearchItems, RetrieveWebMapGroups, RetrieveWebMapGroupItems, QueryResponseToResultsList, PortalItemFactory, LaunchItem, Show, InViewPort) {
			...
			return declare([BaseWidget], {
						...
						startup: function startup() {
									...
									this._retrieveWebMapGroupsCategories.request("WebMapGroupsForCategories", lang.hitch(this, this._handleCategoriesGroups));

									this._retrieveWebMapGroupsOrganisations = new RetrieveWebMapGroups(options);
									this._retrieveWebMapGroupsOrganisations.request("WebMapGroupsForOrganisations", lang.hitch(this, this._handleOrganisationsGroups));
						...
						}, _handleDefaultWebMapSearchItems: function _handleDefaultWebMapSearchItems(error, response) {
									if (error) {
												throw error;
									}
						...
						_retrieveAdditionalDefaultWebMapSearchItems: function _retrieveAdditionalDefaultWebMapSearchItems(err, response) {

									this._retrieveWebMapSearchItems.offset = this._defaultResults.length;
									this._retrieveWebMapSearchItems.query = "";
									this._retrieveWebMapSearchItems.callback = lang.hitch(this, this._handleDefaultWebMapSearchItems);
									this._retrieveWebMapSearchItems.request();
						}, _handleCategoriesGroups: function _handleCategoriesGroups(error, response) {
									if (error) throw error;

									var searchResults = response;
									this._categories = this._queryResultToResultsList.addToResultsList(searchResults, "WebMapGroupsForCategories");
						},
						_handleOrganisationsGroups: function _handleOrganisationsGroups(error, response) {
									if (error) throw error;

									var searchResults = response;
									this._organisations = this._queryResultToResultsList.addToResultsList(searchResults, "WebMapGroupsForOrganisations");
						},
						_triggerRetrieveWebMapGroupItems: function _triggerRetrieveWebMapGroupItems(error, response) {

									if (response.source == "WebMapGroupsForCategories") {
												this._breadCrumbWidget.addThirdLabel("Results", lang.hitch(this, this._showCategoryGroupsView));
									} else if (response.source == "WebMapGroupsForOrganisations") {
												this._breadCrumbWidget.addThirdLabel("Results", lang.hitch(this, this._showOrganisationGroupsView));
									}
						...
						_triggerRetrieveWebMapSearchItems: function _triggerRetrieveWebMapSearchItems(error, response) {
						...
						_retrieveAdditionalWebMapItems: function _retrieveAdditionalWebMapItems() {
									this._currentSearchTarget.offset = this._currentResults.length;
									this._currentSearchTarget.request();
						},
						_handleWebMapGroupItems: function _handleWebMapGroupItems(error, response) {
						...
						_handleWebMapSearchItems: function _handleWebMapSearchItems(error, response) {
						...
						_handleItemAction: function _handleItemAction(error, response) {
									this._launchItem.open(response);
						},
						_showHomeView: function _showHomeView(err, response) {
						...
						_showCategoryGroupsView: function _showCategoryGroupsView(error, response) {
						...
						_showOrganisationGroupsView: function _showOrganisationGroupsView(error, response) {
