define(['dojo/_base/declare'], function (declare, PortalItemFactory) {
  return declare("QueryResultToResultsList", [], {
    _portalItemFactory: null,
    _resultsList: [],
    constructor: function constructor(portalItemFactory) {
      this._portalItemFactory = portalItemFactory;
    },
    addToResultsList: function addToResultsList(queryResult, source) {
