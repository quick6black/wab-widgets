define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/on', 'dojo/dom-class', 'dojo/dom-attr', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dojo/text!./widget.html'], function (declare, lang, on, domClass, domAttr, _WidgetBase, _TemplatedMixin, widgetTemplate) {
	return declare('MapThumbWidget', [_WidgetBase, _TemplatedMixin], {
		templateString: widgetTemplate,
		_item: null,
		_callback: null,
		constructor: function constructor(item, callback) {
			this._item = item;
		...
		startup: function startup() {
			...
			var imgSrc = "http://www.arcgis.com/sharing/rest/content/items/" + this._item.Id + "/info/" + this._item.ThumbnailUrl;
		...
		_openWebMap: function _openWebMap( /*Event*/e) {
			e.preventDefault();
			var response = {
				item: this._item,
				action: "openWebMap"
		...
		_openDetails: function _openDetails( /*Event*/e) {
			e.preventDefault();
			var response = {
				item: this._item,
				action: "openDetails"
