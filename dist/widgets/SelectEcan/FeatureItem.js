...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/event', 'dojo/on', 'dojo/dom-geometry', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dojo/text!./FeatureItem.html', 'jimu/utils', 'jimu/symbolUtils', 'jimu/dijit/FeatureActionPopupMenu', 'jimu/featureActions/PanTo', 'jimu/featureActions/ShowPopup'], function (declare, lang, html, Event, on, domGeom, _WidgetBase, _TemplatedMixin, template, jimuUtils, symbolUtils, PopupMenu, PanToAction, ShowPopupAction) {
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    postCreate: function postCreate() {
      ...
      var title;
      if (this.featureLayer && this.featureLayer.infoTemplate && typeof this.featureLayer.infoTemplate.title === 'function') {
        title = this.featureLayer.infoTemplate.title(this.graphic);
      } else {
        title = this.graphic.attributes[this.displayField] || this.graphic.attributes[this.objectIdField];
      }
