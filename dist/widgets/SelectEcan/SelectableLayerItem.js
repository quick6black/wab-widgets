...
define(['dojo/_base/declare', 'dojo/_base/html', 'dojo/_base/lang', 'dojo/_base/event', 'dojo/on', 'dojo/Evented', 'dojo/dom-geometry', 'jimu/utils', 'jimu/dijit/FeatureActionPopupMenu', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./SelectableLayerItem.html', './ClearSelectionAction'], function (declare, html, lang, Event, on, Evented, domGeom, jimuUtils, PopupMenu, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, ClearSelectionAction) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    init: function init(layerObject) {
    ...
    isLayerVisible: function isLayerVisible() {
    ...
    _toggleChecked: function _toggleChecked(event) {
      Event.stop(event);
    ...
    _toggleContent: function _toggleContent(event) {
      Event.stop(event);
    ...
    _showActions: function _showActions(event) {
      Event.stop(event);
