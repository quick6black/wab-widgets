...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/array', 'dojo/_base/window', 'dojo/window', 'dojo/query', 'dojo/on', 'dojo/dom', 'dojo/dom-construct', 'dojo/dom-attr', 'dojo/dom-class', 'dojo/dom-geometry', 'Dojo-Bootstrap/Popover', 'Dojo-Bootstrap/Tooltip'], function (declare, lang, array, basewin, win, query, on, dom, domConstruct, domAttr, domClass, domGeom) {
    ...
    return declare(null, {
        ...
        showStep: function showStep(i) {
            ...
            showStepHelper = function (_this) {
                return function (e) {
                    ...
                    showPopoverAndOverlay = function showPopoverAndOverlay() {
        ...
        setCurrentStep: function setCurrentStep(value) {
            if (value != null) {
                this._current = value;
        ...
        _setState: function _setState(key, value) {
            var e, keyName;
        ...
        _removeState: function _removeState(key) {
            var keyName;
            if (this._options.storage) {
                keyName = "" + this._options.name + "_" + key;
        ...
        _getState: function _getState(key) {
            var keyName, value;
            if (this._options.storage) {
                keyName = "" + this._options.name + "_" + key;
        ...
        _showPrevStep: function _showPrevStep() {
        ...
        _isRedirect: function _isRedirect(path, currentPath) {
            return path != null && path !== '' && ({}.toString.call(path) === '[object RegExp]' && !path.test(currentPath) || {}.toString.call(path) === '[object String]' && path.replace(/\?.*$/, '').replace(/\/?$/, '') !== currentPath.replace(/\/?$/, ''));
        },

        _redirect: function _redirect(step, path) {
        ...
        _isOrphan: function _isOrphan(step) {
        ...
        _isLast: function _isLast() {
            return this._current < this._options.steps.length - 1;
        },

        _showPopover: function _showPopover(step, i) {
        ...
        _template: function _template(step, i) {
        ...
        _reflexEvent: function _reflexEvent(reflex) {
        ...
        _reposition: function _reposition($tip, step) {
        ...
        _center: function _center($tip) {
            return $tip.css('top', query(window).outerHeight() / 2 - $tip.outerHeight() / 2);
        },

        _replaceArrow: function _replaceArrow($tip, delta, dimension, position) {
            return $tip.find('.arrow').css(position, delta ? 50 * (1 - delta / dimension) + '%' : '');
        },

        _scrollIntoView: function _scrollIntoView(element, callback) {
        ...
        _onResize: function _onResize(callback, timeout) {
        ...
        _initMouseNavigation: function _initMouseNavigation() {
            array.forEach(this._handles, function (handle) {
                handle.remove();
            });

            this._handles.push(on(document, on.selector(".tour-" + this._options.name + " [data-role='next']", "click"), lang.hitch(this, function (evt) {
                evt.preventDefault();
                return this.next();
            })));

            this._handles.push(on(document, on.selector(".tour-" + this._options.name + " [data-role='prev']", "click"), lang.hitch(this, function (evt) {
                evt.preventDefault();
                return this.prev();
            })));

            this._handles.push(on(document, on.selector(".tour-" + this._options.name + " [data-role='end']", "click"), lang.hitch(this, function (evt) {
                evt.preventDefault();
                return this.end();
            })));
        },

        _initKeyboardNavigation: function _initKeyboardNavigation() {
            if (!this._options.keyboard) {
                return;
            }

            this._keyboardHandles.push(on(document, "keyup", lang.hitch(this, function (e) {
                if (!e.which) {
                    return;
                }
                switch (e.which) {
        ...
        _makePromise: function _makePromise(result) {
        ...
        _callOnPromiseDone: function _callOnPromiseDone(promise, cb, arg) {
            if (promise) {
        ...
        _showBackdrop: function _showBackdrop(element) {
        ...
        _hideBackdrop: function _hideBackdrop() {
            this._hideOverlayElement();
            return this._hideBackground();
        },

        _hideBackground: function _hideBackground() {
            if (this.backdrop) {
        ...
        _showOverlayElement: function _showOverlayElement(step) {
        ...
        _hideOverlayElement: function _hideOverlayElement() {
        ...
        _applyBackdropPadding: function _applyBackdropPadding(padding, data) {
